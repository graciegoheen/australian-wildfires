# Reads in temperature data, gathered from the Australian Bureau of Meterology (BoM). 
...
# Parameters
url_data <- "https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2020/2020-01-07/temperature.csv"
file_output_path <- here::here("c01-own/data/temperature.rds")
